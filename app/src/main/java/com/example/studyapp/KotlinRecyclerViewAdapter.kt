...
class KotlinRecyclerViewAdapter(private val titleList: ArrayList<String>, private val infoList: ArrayList<String>,
    ...
    override fun onBindViewHolder(holder: ItemViewHolder, position: Int) {
        ...
        holder.itemView.apply {
            tvKotlinTitle.text = title
            tvKotlinInfo.text = info
